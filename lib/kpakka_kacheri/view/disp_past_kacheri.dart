...
class DispPastKacherry extends StatelessWidget {
  ...
  Future<bool> _onPressBack() async {
   //kpakkamController
   //    .getKpakkam(task: 'getKpakkam.php', param: {'action': 'NEXT'});
    return true;
  }
              ...
              Expanded(
                child: GetX<KpakkamController>(builder: (controller) {
                  return kpakkamController.isLoading.isFalse
                      ? ListView.builder(
                          itemCount: controller.kPakkamP.length,
                            ...
                            return Card(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      Text(
                                        '${controller.kPakkamP[index].topic}',
                                        style: TextStyle(
                                          fontSize: 20,
                                          color: Colors.red,
                                        ),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          //'$url2${controller.kPakkamP[index].uid}.png',
                                        //   CachedNetworkImage(
                                        ...
                                        //  ),
                                           ...
                                           Container(
                                            ...
                                            //'$url${controller.kPakkamP[index].poster}',
                                         //CachedNetworkImage(
                                         //  placeholder: (context, url) =>
                                         //      const CircularProgressIndicator(),
                                         //  imageUrl:
